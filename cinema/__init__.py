...
def create_app(test_config=None):
    ...
    # app.config["SQLALCHEMY_DATABASE_URI"] = "mysql+mysqldb://22_appweb_31:9JoOBTaL@mysql.lab.it.uc3m.es/22_appweb_31b"
    ...
    login_manager.login_message = "You need to Log in to see this functionality"
